/** v2.8.1 | MIT Licensed */ !(function (d) {
    "use strict";
    var t,
      h = d.document,
        ...
        return (
          ...
          "string" == typeof l && l
            ...
            : ((s.dateTime = d.systemDate()),
              ...
              delete d.endTime),
          d.rangeElem &&
            ((c = [d.rangeElem[0].val(), d.rangeElem[1].val()]),
      ...
      (I.prototype.calendar = function (e, t, a) {
        ...
        return (
          ...
          "cn" === n.lang
            ? (lay(c[0])
              ...
              lay(c[1])
                .attr("lay-type", "month")
                .html(d.month + 1 + " \u6708"))
            : (lay(c[0]).attr("lay-type", "month").html(y.month[d.month]),
          ...
          n.range ||
            ...
            o.limit({ elem: lay(o.footer).find(C), index: 0, time: u })),
          o.setBtnStatus(),
          lay(o.shortcut)
            .find("li." + x)
            .removeClass(x),
      ...
      i =
        ...
        (h.min = function (e, t) {
          ...
          var i,
            ...
            s,
            l = m("#" + d[0] + e),
            r = l.data("maxminStatus");
          "min" !== r &&
            ("max" === r && h.restore(e),
            l.data("maxminStatus", "min"),
            (r = m("#" + d.SHADE + e)),
            (i = l.find(d[1]).outerHeight() || 0),
            (a = (n = "string" == typeof (a = l.attr("minLeft")))
              ? a
            ...
            0 < f.minStackArr.length &&
              ((a = f.minStackArr[0]), f.minStackArr.shift()),
            parseFloat(a) + 180 > c.width() &&
              (a =
                c.width() -
                180 -
            ...
            "page" === l.attr("type") && l.find(d[4]).hide(),
            f.rescollbar(e),
            r.hide());
        }),
        ...
        (h.close = function (a, o) {
          ...
          l[0] &&
            ...
            t.isOutAnim && l.addClass("layer-anim " + i),
    ...
    var s = layui.$,
      ...
      o = {
        ...
        countdown: function (e, t, n) {
          ...
          return (
            n && n(0 < a ? l : [0, 0, 0, 0], t, o), a <= 0 && clearTimeout(o), o
          );
        },
  ...
  layui.define(["lay", "layer"], function (e) {
    ...
    (w.prototype.config = {
          ...
          switch (r.accept) {
            ...
            case "video":
              layui.each(h, function (e, t) {
                if (
                  !RegExp(
                    ".\\.(" + (m || "avi|mp4|wma|rmvb|rm|flash|3gp|flv") + ")$",
                    "i"
                  ).test(escape(t))
                )
                  return (i = !0);
      ...
      (w.prototype.reload = function (e) {
        ...
        (e = this.config = y.extend({}, this.config, i.config, e)).elem
          .next()
        ...
        var n = this,
          ...
          l = function (e, t) {
            ...
            i.next().hasClass(x) && i.next().remove(),
              ...
              n.isFile() ||
                a.choose ||
                i.after('<span class="layui-inline ' + x + '">' + e + "</span>");
          },
          r = function () {
            var e = y(this);
            ...
            n = {
                  ...
                  a
                    ...
                    .each(function () {
                      var l = b(this),
                        ...
                        c = function (e, t) {
                          (e = b(e))[0] &&
                            e[b.trim(t) ? "removeClass" : "addClass"]($);
                        },
                        n = function (t) {
                          t = b.extend(
                            {},
                            ...
                            e.on("click", function () {
                              ...
                              b(this).hasClass(F) ||
                                ("function" == typeof t.click &&
                                  t.click.call(this, l, t),
                                layui.event.call(
                                  this,
                                  w,
                                  "input-affix(" + e + ")",
                                  { elem: l[0], affix: r, options: t }
                                ));
                            });
                        },
                        u = {
              ...
              select: function (e) {
                var v,
                  ...
                  e = e || a.find("select"),
                  C = function (e, t) {
                    (b(e.target).parent().hasClass(g) && !t) ||
                      (b("." + m).removeClass(m + "ed " + m + "up"),
                      v && k && v.val(k)),
                      (v = null);
                  },
                  u = function (a, e, t) {
  ...
  layui.define(["lay", "laytpl", "laypage", "form", "util"], function (e) {
    ...
    var p = layui.$,
      ...
      n = function (e) {
        (this.index = ++b.index),
          (this.config = p.extend({}, this.config, b.config, e)),
          this.render();
      },
      d =
        ((n.prototype.config = {
          ...
          (a.index = t.index),
            ...
            a.height && /^full-\d+$/.test(a.height)
              ? ((t.fullHeightGap = a.height.split("-")[1]),
                (a.height = I.height() - t.fullHeightGap))
              : a.height &&
                /^#\w+\S*-\d+$/.test(a.height) &&
                ((i = a.height.split("-")),
                        ...
                        (o
                          ...
                          : ((a = t.width || 0),
                            /\d+%$/.test(a)
                              ? l <
                                  (a =
                                    (a = Math.floor((parseFloat(a) / 100) * y)) <
                                    i
                                      ? i
                                      : a) && (a = l)
                              : a
        ...
        (n.prototype.errorView = function (e) {
          ...
          a[0] && (t.layNone.remove(), a.remove()),
            ...
            t.layTotal.addClass(L),
            t.layPage.find(A).addClass(L),
            (b.cache[t.key] = []),
            t.syncCheckAll(),
            t.renderForm(),
            t.setColsWidth();
        ...
        (n.prototype.pullData = function (t, a) {
          ...
          (a = a || {}),
            ...
            n.url
              ? ((e = {}),
                n.page && ((e[o.pageName] = t), (e[o.limitName] = n.limit)),
          ...
          return (
            ...
            layui.each(t, function (o, d) {
              ...
              ("array" === layui.type(d) && 0 === d.length) ||
                ((d[b.config.numbersName] = s),
                a || (d[b.config.indexName] = o),
                    ...
                    l.colGroup ||
                      ((t = [
                        '<td data-field="' +
                          ...
                          ((e = []),
                          (t =
                            "function" == typeof l.edit ? l.edit(d) : l.edit) &&
                            e.push('data-edit="' + t + '"'),
                          l.templet &&
                ...
                h.push('<tr data-index="' + o + '">' + r.join("") + "</tr>"),
                f.push('<tr data-index="' + o + '">' + c.join("") + "</tr>"));
            }),
        ...
        (n.prototype.renderData = function (e) {
          var a = this,
            ...
            y = function () {
              if (
                (i.HAS_SET_COLS_PATCH || a.setColsPatch(),
              ...
              a.getTrHtml(d, o, l, { trs: r, trs_fixed: c, trs_fixed_r: s }),
                ...
                a.renderForm(),
                "number" == typeof a.thisCheckedRowIndex &&
                  a.setRowChecked(
                    { type: "radio", index: a.thisCheckedRowIndex },
                    !0
                  ),
                a.syncCheckAll(),
                a.fullSize(),
          ...
          return (
            (b.cache[a.key] = d),
            a.layTotal[0 == d.length ? "addClass" : "removeClass"](L),
            a.layPage[i.page || i.pagebar ? "removeClass" : "addClass"](T),
            a.layPage
              .find(A)
              [
            ...
            0 === d.length
              ...
              : (a.layFixLeft.removeClass(T),
                o
                  ? y()
                  : (y(),
                    a.renderTotal(d, t),
                    a.layTotal && a.layTotal.removeClass(T),
                    void (
                      i.page &&
                      ((i.page = p.extend(
                        {
        ...
        (n.prototype.setRowChecked = function (a, e) {
          ...
          "checkbox" !==
            (a = p.extend({ type: "checkbox", checked: !0 }, a)).type &&
            "all" !== a.index &&
            n.addClass(l).siblings("tr").removeClass(l),
            a.selectedStyle ||
              e ||
              ((l = b.cache[t.key]),
              layui.each(l, function (e, t) {
                a.index === e || "all" === a.index
                  ? (t[i.checkName] = a.checked)
          ...
          (t.sortKey = { field: d, sort: l.type }),
            i.autoSort &&
              ("asc" === l.type
                ...
                : "desc" === l.type
                ? (e = layui.sort(o, d, !0))
                : ((e = layui.sort(o, b.config.indexName)),
                  delete t.sortKey,
                  delete i.initSort)),
        ...
        (n.prototype.fullSize = function () {
          var e,
            ...
            l = t.height;
          i.fullHeightGap
            ? ((l = I.height() - i.fullHeightGap),
              i.elem.css("height", (l = l < 135 ? 135 : l)))
            : i.parentDiv &&
              i.parentHeightGap &&
              ((l = p(i.parentDiv).height() - i.parentHeightGap),
              i.elem.css("height", (l = l < 135 ? 135 : l))),
            1 < t.cols.length &&
        ...
        (n.prototype.scrollPatch = function () {
          ...
          e.layFixed.find(_).css("height", t.height() >= n ? n : "auto"),
            e.layFixRight[
              b.cache[e.key] && b.cache[e.key].length && 0 < l
                ? "removeClass"
                : "addClass"
            ](T),
            ...
            n =
                  ...
                  l = function (e) {
                    ...
                    a.html(t),
                      y.height &&
                        a.css(
                          "max-height",
                          y.height - (s.layTool.outerHeight() || 50)
                        ),
                  ...
                  d.allowResize &&
                    ...
                    s.getCssRule(t, function (e) {
                      ...
                      (d.rule = e),
                        ...
                        (d.minWidth = a.data("minwidth") || y.cellMinWidth),
                        (d.maxWidth = a.data("maxwidth") || y.cellMaxWidth);
                    }),
                    a.data(S, d),
                    (x.eventMoveElem = a));
                }),
              x.docEvent ||
                F.on("mousemove", function (e) {
                  var t, a;
                  x.eventMoveElem &&
                    ((t = x.eventMoveElem.data(S) || {}),
                    x.eventMoveElem.data("resizing", 1),
                    e.preventDefault(),
                    t.rule &&
                      ((e = t.ruleWidth + e.clientX - t.offset[0]),
                      (a = x.eventMoveElem.closest("." + R).attr("lay-id")),
                      (a = k(a)) &&
                        ((e = e < t.minWidth ? t.minWidth : e) > t.maxWidth &&
                          (e = t.maxWidth),
                        (t.rule.style.width = e + "px"),
                        a.setGroupWidth(x.eventMoveElem),
                        h.close(s.tipsIndex))));
                }).on("mouseup", function (e) {
                  var t, a, i, l, n;
                  x.eventMoveElem &&
                    ((i = (t = x.eventMoveElem).closest("." + R).attr("lay-id")),
                    (a = k(i)) &&
                      ((i = t.data("key")),
                      (l = a.col(i)),
                      ...
                      a.getCssRule(i, function (e) {
                        (l.width = parseFloat(e.style.width)),
                          layui.event.call(t[0], w, "colResized(" + n + ")", {
                            col: l,
                            config: a.config,
                          });
                      })));
            ...
            t =
              ...
              s.elem.on("click", 'input[lay-type="layTableRadio"]+', function () {
                var e = p(this).prev(),
                  ...
                  a = e.parents("tr").eq(0).data("index");
                e[0].disabled ||
                  (s.setRowChecked({ type: "radio", index: a }),
                  layui.event.call(
                    e[0],
                    w,
                    "radio(" + r + ")",
                    n.call(e[0], { checked: t })
                  ));
              }),
              s.layBody
                ...
                .on("contextmenu", "tr", function (e) {
                  y.defaultContextmenu || e.preventDefault(),
            ...
            c = function (e, t) {
              ...
              (e = p(e)).data("off") ||
                ...
                (n = "function" == typeof n.edit ? n.edit(i) : n.edit) &&
                  (((n = p(
                    "textarea" === n
                      ? '<textarea class="layui-input ' + W + '"></textarea>'
                      : '<input class="layui-input ' + W + '">'
            ...
            i =
              (s.layBody
                .on("change", "." + W, function () {
                  ...
                  (e[i] = a),
                    l.update(e),
                    layui.event.call(t[0], w, "edit(" + r + ")", l);
                })
                .on("blur", "." + W, function () {
                  p(this).remove();
                }),
              s.layBody
                .on(y.editTrigger, "td", function (e) {
                  c(this, e);
                })
            ...
            l =
              ...
              function (e) {
                ...
                layui.event.call(
                  ...
                  s.setRowChecked({ type: "radio", index: a }, !0);
              });
          s.layBody
          ...
          return (
            e.each(function () {
              ...
              !a.length ||
                ...
                t.config.url ||
                ((l = 0),
                b.eachCols(t.config.id, function (e, i) {
                  a.each(function (e) {
                    n.data[e] = n.data[e] || {};
                    var t = p(this),
                      a = i.field;
    ...
    (b.eachCols = function (e, a, i) {
            ...
            layui.each(t, function (i, l) {
              ...
              "object" == typeof e
                ? (layui.each(e, function (e, t) {
                  ...
                  layui.each(
                    layui.isArray(l) ? p.extend([], l) : b.clearCacheKey(l),
                    function (e, t) {
                      n.push('"' + (t || "") + '"');
                    }
                  ))
      ...
      (b.clearCacheKey = function (e) {
        return (
          delete (e = p.extend({}, e))[b.config.checkName],
          delete e[b.config.indexName],
          delete e[b.config.numbersName],
  ...
  layui.define(["table"], function (e) {
    ...
    var O = layui.$,
      ...
      L = ".layui-table-main",
      j = ".layui-table-fixed-l",
      P = ".layui-table-fixed-r",
      B = "LAY_DATA_INDEX",
      ...
      t = function (e) {
        var t = this;
        (t.index = ++p.index),
          (t.config = O.extend(!0, {}, t.config, p.config, e)),
          t.init(),
          t.render();
      },
      c = function (n, i, e) {
    ...
    (t.prototype.init = function () {
      var i = this,
        e = i.config,
        t = Y.render(O.extend({}, e, { data: [], url: "", done: null })),
        l = t.config.id,
        a = (((o.that[l] = i).tableIns = t), e.tree),
        t = a.customName,
        r = (t.isParent, t.children),
        n = e.parseData,
        d = e.done;
      e.url
        ? (e.parseData = function () {
            var e = arguments,
              t = e[0],
              e =
                ("function" === layui.type(n) && (t = n.apply(this, e) || e[0]),
                this.response.dataName);
            return (
              a.data.isSimpleData &&
                !a["async"].enable &&
                (t[e] = i.flatToTree(t[e])),
              i.initData(t[e]),
              t
            );
          })
        : ((e.data = e.data || []),
          a.data.isSimpleData && (e.data = i.flatToTree(e.data)),
          e.initSort &&
            e.initSort.type &&
            (e.data = layui.sort(
              e.data,
        ...
        (e.done = function () {
          var e,
            ...
            a = this.elem.next(),
            n =
              (i.updateStatus(null, { LAY_HAS_EXPANDED: !1 }),
              c(l, r),
              a.find(
      ...
      (t.prototype.getOptions = function () {
        return this.tableIns
          ? Y.getOptions(this.tableIns.config.id)
          : this.config;
      }),
      ...
      (t.prototype.getNodeDataByIndex = function (a, e, t) {
        ...
        for (
          var r = this.getTableData(),
            d = (a += "").split("-"),
            o = r,
            c = n.url || 1 < d.length ? null : Y.cache[l],
            u = 0,
    ...
    var U = function (t, a, n, i, l) {
        var e = t.trElem,
          r = e.closest(".layui-table-view"),
          d = (r.attr("lay-filter"), r.attr("lay-id")),
          o = Y.getOptions(d),
          c = o.tree || {},
          u = c.customName || {},
          f = u.isParent,
          s = e.attr("lay-data-index"),
          y = E(d),
          p = (y.getTableData(), y.getNodeDataByIndex(s)),
          h = (e.data("level") || 0) + 1,
          x = "boolean" !== layui.type(a),
          e = x ? !p[F] : a,
          m = p[f] ? e : null;
        if (
          l &&
          e != p[F] &&
          (!p.LAY_ASYNC_STATUS || "local" === p.LAY_ASYNC_STATUS)
        ) {
          var b = c.callback.beforeExpand;
          if ("function" === layui.type(b) && !1 === b(d, p, a)) return m;
        }
        var b = p[X],
          g = r.find('tr[lay-data-index="' + s + '"]'),
          v = g.find(".layui-table-tree-flexIcon"),
          f =
            (v.html(e ? c.view.flexIconOpen : c.view.flexIconClose),
            ...
            c.view.showIcon &&
              ...
              !c.view.icon &&
              g
                .find(".layui-table-tree-nodeIcon")
                .html(e ? c.view.iconOpen : c.view.iconClose),
            p[u.children] || []);
        if (e)
          if (b)
            (p[F] = e),
              ...
              layui.each(f, function (e, t) {
                n && !x
                  ? U(
                      {
                        trElem: r
                          .find('tr[lay-data-index="' + t.LAY_DATA_INDEX + '"]')
                          .first(),
                      },
                      a,
                      n,
            ...
            var N,
              ...
              g = c["async"] || {},
              w = g.url || o.url;
            if (g.enable && w && !p.LAY_ASYNC_STATUS)
              return (
                (p.LAY_ASYNC_STATUS = "loading"),
                (N = O.extend({}, g.where || o.where)),
                (T = g.autoParam),
                layui.each(T, function (e, t) {
                  t = t.split("=");
                  N[t[0].trim()] = p[(t[1] || t[0]).trim()];
                }),
                (T = g.contentType || o.contentType) &&
                  0 == T.indexOf("application/json") &&
                  (N = JSON.stringify(N)),
                (C = g.method || o.method),
                (_ = g.dataType || o.dataType),
                (A = g.jsonpCallback || o.jsonpCallback),
                (D = g.headers || o.headers),
                (I = g.parseData || o.parseData),
                (S = g.response || o.response),
                v.html(
                ...
                O.ajax({
                  ...
                  headers: D || {},
                  success: function (e) {
                    (p.LAY_ASYNC_STATUS = "success"),
                      (e = "function" == typeof I ? I.call(o, e) || e : e)[
                        S.statusName
                      ] != S.statusCode
                        ? ((p.LAY_ASYNC_STATUS = "error"),
                          v.html('<i class="layui-icon layui-icon-refresh"></i>'))
                        : ((p[u.children] = e[S.dataName]),
                          y.initData(p[u.children], p[B]),
                          U(t, !0, !x && n, i, l));
                  },
                  error: function (e, t) {
                    (p.LAY_ASYNC_STATUS = "error"),
            ...
            (p[F] = e),
              ...
              f.length &&
                (o.initSort &&
                  !o.url &&
                  (f = (g = o.initSort).type
                    ? (p[u.children] = layui.sort(f, g.field, "desc" === g.type))
                    : (p[u.children] = layui.sort(f, Y.config.indexName))),
                y.initData(p[u.children], p[B]),
                (C = Y.getTrHtml(d, f, null, null, s)),
                (k = {
                  trs: O(C.trs.join("")),
                ...
                r
                  .find(L)
                  .find('tbody tr[lay-data-index="' + s + '"]')
                  .after(k.trs),
                r
                  .find(j)
                  .find('tbody tr[lay-data-index="' + s + '"]')
        ...
        return (
          Y.resize(d),
          l &&
            "loading" !== p.LAY_ASYNC_STATUS &&
            ((T = c.callback.onExpand),
            "function" === layui.type(T) && T(d, p, a)),
          m
        );
      },
      l =
        ...
        (p.expandAll = function (e, t) {
          if ("boolean" !== layui.type(t))
            return i.error(
              "expandAll\u7684\u5c55\u5f00\u72b6\u6001\u53c2\u6570\u53ea\u63a5\u6536true/false"
            );
          e = E(e);
          if (e) {
            var a = e.getOptions(),
              ...
              a = a.elem.next();
            if (t)
              return i.error("\u6682\u4e0d\u652f\u6301\u5c55\u5f00\u5168\u90e8");
            else {
              e.updateStatus(null, { LAY_EXPAND: !1 }),
                a.find('tbody tr[data-level!="0"]').addClass("layui-hide");
              t = a.find('tbody tr[data-level="0"]');
              t.find(".layui-table-tree-flexIcon").html(n.view.flexIconClose),
                t.find(".layui-table-tree-nodeIcon").html(n.view.iconClose),
                p.resize();
            }
          }
        }),
        (t.prototype.renderTreeTable = function (e, l, t) {
          var a = this.getOptions(),
            n = a.elem.next(),
            i = (n.addClass("layui-table-tree"), a.id),
            r = a.tree || {},
            d = (r.data, r.view || {}),
            a = r.customName || {},
            o = a.isParent,
            ...
            f =
              ((l = l || 0) ||
                (n
                  ...
                  .attr("data-level", l),
                layui.each(Y.cache[i], function (e, t) {
                  n
                    .find(
                      '.layui-table-main tbody tr[data-level="0"]:eq(' + e + ")"
                    )
                    .attr("lay-data-index", t[B]),
                    n
                      .find(
          ...
          layui.each(e.find('td[data-field="' + a + '"]'), function (e, t) {
            ...
            i.hasClass("layui-table-tree-item") ||
              (i.addClass("layui-table-tree-item"),
              (i = n.attr("lay-data-index")) &&
                ((a = u.getNodeDataByIndex(i))[F] && (f[i] = !0),
                (i = t.find("div.layui-table-cell").html()),
                t
                  .find("div.layui-table-cell")
                  .html(
                    [
                      '<div class="layui-inline layui-table-tree-flexIcon" ',
                      'style="',
                      "margin-left: " + s * l + "px;",
                      a[o] || d.showFlexIconIfNotParent
                        ? ""
                        : " visibility: hidden;",
                      '">',
                      ...
                      (r.view.showIcon &&
                        (a.icon ||
                          r.view.icon ||
                          (a[o] ? r.view.iconClose : r.view.iconLeaf))) ||
                        "",
                      "</div>",
                      i,
                    ].join("")
            ...
            !1 !== t &&
              layui.each(f, function (e, t) {
                ...
                e.find(".layui-table-tree-flexIcon").html(r.view.flexIconOpen),
                  U({ trElem: e.first() }, !0);
              }),
            p.formatNumber(i),
            y.render(null, c);
        ...
        (p.formatNumber = function (e) {
          ...
          if (l)
            return (
              ...
              (i = 0),
              layui.each(l.treeToFlat(Y.cache[e]), function (e, t) {
                var a;
                layui.isArray(t) ||
                  (((a = l.getNodeDataByIndex(t.LAY_DATA_INDEX)).LAY_NUM = ++i),
                  n
                    .find(
                      'tr[lay-data-index="' +
                        t.LAY_DATA_INDEX +
        ...
        (t.prototype.render = function (e) {
          var t = this;
          (t.tableIns = Y["reloadData" === e ? "reloadData" : "reload"](
        ...
        (t.prototype.reload = function (e, t, a) {
          ...
          (e = e || {}),
            ...
            (n.config = O.extend(t, {}, n.config, e)),
            n.render(a);
        }),
        (p.reloadData = function () {
        ...
        function (e, a, n) {
          ...
          return (
            layui.each(e, function (e, t) {
              "function" === layui.type(a) ? a(t) : O.extend(t, a),
                i.push(O.extend({}, t)),
                (i = i.concat(l(t[n], a, n)));
            }),
            i
          );
        }),
      n =
        ...
        (p.updateStatus = function (e, t, a) {
          var e = E(e),
            n = e.getOptions();
          return (
            (a = a || (n.url ? Y.cache[n.id] : n.data)), e.updateStatus(a, t)
          );
        }),
        (p.sort = function (e) {
          var t,
            ...
            l = E(e);
          l &&
            ((a = (t = l.getOptions()).initSort),
            t.url
              ? t.autoSort &&
                ((n = l.initData()),
                ((i = {})[t.response.dataName] = n),
                "function" == typeof t.done && t.done(i, l.page, l.count))
              : (a.type
                  ? (t.data = layui.sort(t.data, a.field, "desc" === a.type))
                  : (t.data = layui.sort(t.data, Y.config.indexName)),
                l.initData(t.data),
                p.reloadData(e)));
        }),
        function (t) {
          var a = t.config.id,
            n = E(a),
            i = (t.data = p.getNodeDataByIndex(a, t.index)),
            l = i[B],
            r = ((t.dataIndex = l), t.update);
          (t.update = function () {
            var e = arguments,
              e = (O.extend(n.getNodeDataByIndex(l), e[0]), r.apply(this, e));
      ...
      u =
        ((p.updateNode = function (e, a, t) {
          ...
          d &&
            ((l = d.getOptions()).tree,
            (l = (n = l.elem.next()).find('tr[lay-data-index="' + a + '"]')),
            (i = l.attr("data-index")),
            (l = l.attr("data-level")),
            t &&
              ((t = d.getNodeDataByIndex(a, !1, t)),
              (r = Y.getTrHtml(e, [t])),
              layui.each(["main", "fixed-l", "fixed-r"], function (e, t) {
                n.find(
                  ".layui-table-" + t + ' tbody tr[lay-data-index="' + a + '"]'
                ).replaceWith(
                  O(r[["trs", "trs_fixed", "trs_fixed_r"][e]].join("")).attr({
                    "data-index": i,
                    "lay-data-index": a,
                  })
                );
        ...
        (p.removeNode = function (e, t) {
          var a,
            ...
            r = E(e);
          r &&
            ((l = (i = r.getOptions()).tree),
            (a = i.elem.next()),
            (n = []),
            (i = r.getNodeDataByIndex(
              "string" === layui.type(t) ? t : t[B],
              !1,
              "delete"
            )),
            (t = r.getNodeDataByIndex(i[f])),
            r.updateCheckStatus(t, !0),
            (t = r.treeToFlat([i], i[l.customName.pid], i[f])),
            layui.each(t, function (e, t) {
              n.push('tr[lay-data-index="' + t[B] + '"]');
            }),
            a.find(n.join(",")).remove(),
            (l = r.initData()),
            layui.each(r.treeToFlat(l), function (e, t) {
              t[h] &&
                t[h] !== t[B] &&
                a
                  .find('tr[lay-data-index="' + t[h] + '"]')
                  .attr({ "data-index": t[B], "lay-data-index": t[B] });
            }),
            layui.each(Y.cache[e], function (e, t) {
              a.find('tr[data-level="0"][lay-data-index="' + t[B] + '"]').attr(
                "data-index",
                e
              );
            }),
        ...
        (p.addNodes = function (e, t) {
          ...
          if (y)
            return (
              ...
              (l = t.data),
              (t = t.focus),
              (n = (s = "number" === layui.type(s) ? s.toString() : s)
                ? y.getNodeDataByIndex(s)
                : null),
              (i = "number" === layui.type(i) ? i : -1),
              (l = O.extend(!0, [], layui.isArray(l) ? l : [l])),
              y.getTableData(),
              n
                ? ((r = f.customName.isParent),
                  ...
                  y.initData(),
                  (n[X] = !1),
                  (n.LAY_ASYNC_STATUS = "local"),
                  U({ trElem: a.find('tr[lay-data-index="' + s + '"]') }, !0))
                : ((d = Y.cache[e].splice(-1 === i ? Y.cache[e].length : i)),
                  (Y.cache[e] = Y.cache[e].concat(l, d)),
                  u.url ||
                    (u.page
                      ? ((c = u.page),
                        u.data.splice.apply(
                          u.data,
                          [c.limit * (c.curr - 1), c.limit].concat(Y.cache[e])
                        ))
                      : (u.data = Y.cache[e])),
                  y.initData(),
                  (f = Y.getTrHtml(e, l)),
                  ...
                  (f = a.find(P)),
                  -1 == s
                    ? (c.find('tr[data-level="0"][data-index="0"]').before(o.trs),
                      u
                        .find('tr[data-level="0"][data-index="0"]')
                        .before(o.trs_fixed),
                      f
                        .find('tr[data-level="0"][data-index="0"]')
                        .before(o.trs_fixed_r))
                    : -1 === i
                    ? (c.find("tbody").append(o.trs),
                      u.find("tbody").append(o.trs_fixed),
                      f.find("tbody").append(o.trs_fixed_r))
                    : ((s = d[0][h]),
                      c
                        .find('tr[data-level="0"][data-index="' + s + '"]')
                        .before(o.trs),
                      u
                        .find('tr[data-level="0"][data-index="' + s + '"]')
                        .before(o.trs_fixed),
                  ...
                  layui.each(Y.cache[e], function (e, t) {
                    a.find(
                      'tr[data-level="0"][lay-data-index="' + t[B] + '"]'
                    ).attr("data-index", e);
                  }),
                  y.renderTreeTable(
                    a.find(
        ...
        (t.prototype.updateCheckStatus = function (e, t) {
          var a = this.getOptions(),
            n = (a.tree, a.id),
            i = a.elem.next(),
            l = Y.config.checkName,
            r =
              (e &&
                ((a = this.updateParentCheckStatus(e, t)),
                layui.each(a, function (e, t) {
                  y.render(
                    i
                      .find(
                      ...
                      .prop({ checked: t[l], indeterminate: t[s] })
                  );
                })),
              !0),
            d = !1;
          return (
            layui.each(Y.cache[n], function (e, t) {
              (t[l] || t[s]) && (d = !0), t[l] || (r = !1);
            }),
            (d = d && !r),
            y.render(
        ...
        (t.prototype.updateParentCheckStatus = function (a, n) {
          ...
          return (
            ...
            l.push(O.extend({}, a)),
            (l = a[f]
              ? l.concat(this.updateParentCheckStatus(Y.cache[e][a[f]], n))
              : l)
          );
        }),
        function (e, t, a) {
          ...
          if (a) {
            ...
            var c,
              ...
              u = Y.config.checkName;
            if (!o)
              return (
                i.tree.customName.isParent,
                (t = "boolean" === layui.type(t) ? t : !a[u]),
                (o = n.updateStatus(a ? [a] : Y.cache[l], function (e) {
    ...
    p.on("checkbox", function (e) {
      var t = e.config,
        ...
        t = E(t);
      a.hasClass("layui-table-tree") &&
        (n(e), (a = e.checked), (e.isAll = u.call(t, e.tr, a)));
    }),
      ...
      (p.getData = function (e, t) {
        var a = [];
        return (
          layui.each(O.extend(!0, [], Y.cache[e] || []), function (e, t) {
            a.push(t);
          }),
      ...
      (p.reload = function (e, t, a, n) {
        if (((a = !1 !== a), E(e).config))
          return (e = E(e)), e.reload(t, a, n), o.call(e);
      }),
      (p.render = function (e) {
        e = new t(e);
        return o.call(e);
          ...
          layui.each(e.elem.get().reverse(), function (e, a) {
            var i,
              ...
              v =
                ...
                0 === l.length && l.push(I(E.html())),
                l),
              f =
                (E.data("code", v),
                y.preview &&
                  ((a = "LAY-CODE-DF-" + e),
                  (t = y.layout || ["code", "preview"]),
                  (s = "iframe" === y.preview),
                  (h = M('<div class="' + b.ELEM_PREVIEW + '">')),
                  (u = M('<div class="layui-tab layui-tab-brief">')),
                  (o = M('<div class="layui-tab-title">')),
                  (n = M(
                    '<div class="' +
                      [
                        b.ELEM_ITEM,
                  ...
                  (m = E.parent("." + b.ELEM_PREVIEW)),
                  (f = E.prev("." + b.ELEM_TAB)),
                  (p = E.next("." + b.ELEM_ITEM + "-preview")),
                  y.id && h.attr("id", y.id),
                  h.addClass(y.className),
                  u.attr("lay-filter", a),
                  layui.each(t, function (e, a) {
                    var l = M('<li lay-id="' + a + '">');
                    0 === e && l.addClass("layui-this"),
                      l.html(y.text[a]),
                      o.append(l);
                  }),
                  (c = {
                    full: {
                      ...
                      event: function (e, a) {
                        var l = e.closest("." + b.ELEM_PREVIEW),
                          i = "layui-icon-" + this.className,
                          t = "layui-icon-screen-restore",
                          s = this.title,
                          o = M("html,body"),
                          n = "layui-scollbar-hide";
                        e.hasClass(i)
                          ? (l.addClass(b.ELEM_FULL),
                            e.removeClass(i).addClass(t),
                            e.attr("title", s[1]),
                            o.addClass(n))
                          : (l.removeClass(b.ELEM_FULL),
                  ...
                  d.on("click", ">i", function () {
                    var e = M(this),
                      a = e.data("type");
                    "function" == typeof c[a].event && c[a].event(e, a),
                      "function" == typeof y.toolsEvent && y.toolsEvent(e, a);
                  }),
                  layui.each(y.tools, function (e, a) {
                    var l = (c[a] && c[a].className) || a,
                      i = c[a].title || [""];
                    d.append(
                      '<i class="layui-icon layui-icon-' +
                        l +
                  ...
                  u.append(o),
                  y.tools && u.append(d),
                  E.wrap(h).addClass(b.ELEM_ITEM).before(u),
                  s && n.html("<iframe></iframe>"),
                  (r = function (e) {
                    var a = e.children("iframe")[0],
                      l =
                        (s && a ? (a.srcdoc = v.join("")) : e.html(v.join("")),
                        {
                          container: e,
                          render: function () {
                  ...
                  "preview" === t[0]
                    ? (n.addClass(b.ELEM_SHOW), E.before(n), r(n))
                    : E.addClass(b.ELEM_SHOW).after(n),
                  (y.codeStyle = [y.style, y.codeStyle].join("")),
                  (y.previewStyle = [y.style, y.previewStyle].join("")),
                  n.attr("style", y.previewStyle),
                  w.on("tab(" + a + ")", function (e) {
                    var a = M(this),
                      l = M(e.elem)
                        ...
                        .find("." + b.ELEM_ITEM),
                      e = l.eq(e.index);
                    l.removeClass(b.ELEM_SHOW),
                      e.addClass(b.ELEM_SHOW),
                      "preview" === a.attr("lay-id") && r(e);
                  })),
                y.ln ? "ol" : "ul"),
              p = M("<" + f + ' class="layui-code-' + f + '">'),
              m = M('<div class="' + b.ELEM_TITLE + '">'),
              h =
                (E.addClass("layui-code-view layui-box"),
                y.skin &&
                  ("notepad" === y.skin && (y.skin = "dark"),
                  E.removeClass("layui-code-dark layui-code-light"),
                  E.addClass("layui-code-" + y.skin)),
                _.escape(v.join(""))),
              h = (h = y.encode ? _.escape(h) : h).replace(
                /[\r\t\n]+/g,
                "</li><li>"
              );
            E.html(p.html("<li>" + h + "</li>")),
              y.header &&
                !E.children("." + b.ELEM_TITLE)[0] &&
                (m.html(
                  y.title +
                    (y.about
                      ? '<div class="layui-code-about">' + y.about + "</div>"
                      : "")
                ),
                E.prepend(m)),
              y.elem.length === e + 1 &&
                "function" == typeof y.allDone &&
                y.allDone(),
              0 < (u = Math.floor(p.find("li").length / 100)) &&
                p.css("margin-left", u + "px"),
              y.height && p.css("max-height", y.height),
              p.attr("style", y.codeStyle);
          });
    });
  }),
